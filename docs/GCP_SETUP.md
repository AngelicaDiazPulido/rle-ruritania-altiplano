...
- Access to the GCP project (e.g., `rle-ruritania-altiplano`)
...
gcloud iam workload-identity-pools create "github-pool" \
  --project="rle-ruritania-altiplano" \
  --location="global" \
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-altiplano" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-altiplano.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-altiplano --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-altiplano.iam.gserviceaccount.com" \
  --project="rle-ruritania-altiplano" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-altiplano.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-altiplano.
